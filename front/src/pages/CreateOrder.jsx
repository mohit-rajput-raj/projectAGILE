...
// import  from '../components/ItemsCard'
    ...
    <div className="dashCon">
      <div className="dashConItem">
        <div className="item1 flex-col">
                ...
                <div>
                  <form className="flex flex-col coForm">
                    <div className="coIPar">
                      <label htmlFor="regPhone">Caption</label>
                      <input
                        type="text"
                        placeholder="caption"
                        className="coInput"
                    ...
                    <div className="decription max-h-40  coIPar overflow-y-scroll">
                      <label htmlFor="regPhone">decription</label>
                      <textarea
                        name="discription"
                        id=""
                    ...
                    <div className="coIPar">
                      <label htmlFor="regPhone">Addressr</label>
                      <input
                        type="text"
                    ...
                    <div className="coIPar">
                      <label htmlFor="regPhone">Amount</label>
                      <input
                        type="text"
                    ...
                    <div className="coIPar">
                      <label htmlFor="regPhone">DeadLine</label>
                      <input type="date" placeholder="orderDeadLine" />
                    </div>
                    <div>
                      <select
                        id="regRole"
                      ...
                      >
                        ...
                        <option value="homemaker">only for workers</option>
                        <option value="shopowner">For all</option>
                      </select>
                    </div>
                    <div
                    ...
                    >
                      ...
                      {[...Array(num)].map((_, i) => (
                        <div key={i} className="bg-pink-100 rounded-2xl h-full">
                          <ItemsCard fun={setNum} />
                        </div>
                      ))}
                      </div>
                    </div>
          ...
          <footer className="w-full bg-zinc-200">Lorem ipsum dolor sit amet consectetur adipisicing elit. At a aspernatur laboriosam iste quasi atque. Consectetur omnis autem aliquam hic et voluptatem aut modi, nostrum impedit deserunt, doloremque, commodi est!
          Libero, rerum placeat dicta pariatur laboriosam officia quas nam expedita aliquam fuga culpa? Nobis, ratione tempore. Impedit itaque adipisci voluptatum id ipsum. Quasi doloremque accusantium non, earum incidunt ex eaque.</footer>
        </div>
      </div>
    </div>
  );
